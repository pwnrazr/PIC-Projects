...
void adc_initialize(void)
{
	...
	// Set AN0, AN1 as analog input, others AN as digital pin
	//ANS0 = 1;
	//ANS1 = 1;
...
unsigned int ui_adc_read(void)
{
	...
	// Select the ADC channel on AN0 for SK40C
		CHS2 = 0;						//CHS selected on main program 
		CHS1 = 0;						//project4.c for different channel
    	CHS0 = 0;						//selection. Please refer to main program.  
